...
Strategy.prototype.authenticate = function(req) {
	try {
        ...
        const username = req.session.lnurlAuth && req.session.lnurlAuth.username;
        const data = {linkingPublicKey: linkingPublicKey, username: username};
		if (linkingPublicKey) {
			return this._verify(data, (error, user, info) => {
